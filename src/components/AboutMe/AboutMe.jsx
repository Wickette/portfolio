      ...
      <div className='max-w-4xl flex items-center h-auto lg:h-screen flex-wrap mx-auto my-32 lg:my-0'>
        <div id='profile' className='w-full lg:w-3/5 rounded-lg lg:rounded-l-lg lg:rounded-r-none shadow-2xl bg-white opacity-75 mx-6 lg:mx-0'>
          <div className='p-4 md:p-12 text-center lg:text-left'>
            ...
            <p className='pt-6 text-sm'>Full Stack web developer leveraging a background in finance to build a more intuitive user experience on the web. Recently earned a certificate in full stack development from the University of Toronto Coding Bootcamp, with newly developed skills in JavaScript, MERN Stack, and responsive web design. Personable individual, with the ability to work with groups or individually while keeping strong self-motivation and self-discipline. I applied aspects of strong attention to detail, as well as excellent time management skills to assist team members and colleagues with a wide range of projects. Fast learner as it relates to new programming languages and dealing with data. I’m excited to leverage my skills as part of a fast-paced, quality-driven team to build better experiences on the web.
            </p>
